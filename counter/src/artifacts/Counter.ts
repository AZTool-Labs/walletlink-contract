...
export class CounterContract extends ContractBase {
  ...
  public declare methods: {
    ...
    /** increment_and_decrement(owner: struct, sender: struct) */
    increment_and_decrement: ((owner: AztecAddressLike, sender: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** increment_twice(owner: struct, sender: struct) */
    increment_twice: ((owner: AztecAddressLike, sender: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
